...
color_ranges = {
    "Handle":((0, 70, 50), (10, 255, 255)),  # Example HSV range for red
...
initial_servo_positions = [0, 90, 80, 90, 0, 0]  # Set each servo to 90 degrees as an example
    ...
    while voice_running:
        ...
        try:
            ...
            if "handle" in command:
                ...
                follow_command_active = True
                active_device = "Scissors"
                print("Tracking Scissors.")

            elif "metzenbaum scissors" in command:
                follow_command_active = True
                ...
                command_str1 = '0,140\n'
                send_command(command_str1)
                print(f"Sent: {command_str1}")
                ...
                send_command(command_str1)
                print(f"Sent: {command_str1}")
                time.sleep(0.5)  # Wait for 0.5 seconds before the next command
                send_command(command_str2)
                print(f"Sent: {command_str2}")
                time.sleep(0.5)  # Wait for 0.5 seconds before the next command
                send_command(command_str3)
                print(f"Sent: {command_str3}")
